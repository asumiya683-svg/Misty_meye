...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Shifat") || (event.body.toLowerCase() == "siam") || (event.body.toLowerCase() == "@Shifat Ahammad Siam") || (event.body.toLowerCase() == "siam")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Shifat Ahammad siam ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 siam.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/shifat.ahammad.siam\nতার সাতে যোগা যোগ করবেন WhatsApp :- +017425***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Shifat Ahammad Siam❤️ হাই আমি মেছেন্জার ROBOT  আামার বস Shifat Ahammad siam  আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Shifat Ahammad Siam ❤️ তাকে সবাই Siam নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Shifat Ahammad Siam") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
